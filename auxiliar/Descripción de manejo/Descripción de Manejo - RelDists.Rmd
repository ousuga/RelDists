...
\justifying
Luego, presione enter. El paquete está instalado, y listo para utilizarse. Cada vez que abra \proglang{RStudio}, usted deberá escribir la siguiente línea de comando para usar **RelDistis**:

```r
library(RelDists)
```

Usted puede visitar el sitio web del paquete ( <https://ousuga.github.io/RelDists/>) **RelDists** para explorar la documentación de las funciones disponibles y su modo de uso.
