...
This distribution was proposed by Bebbington, Chin-Diew and Zitikis (2007). The probability density function $f(x)$ and cumulative density function $F(x)$ are given by:
