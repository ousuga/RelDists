...
To estimate the parameter for the exponentiated Weibull distribution we use the `gamlss` function from __gamlss__ package to estimate the parameters.
