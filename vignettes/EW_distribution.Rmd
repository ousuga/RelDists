...
curve(dEW(x, 0.7, 0.5, 0.15), col="green3", add=TRUE)
curve(dEW(x, 1, 3, 1), col="purple", add=TRUE)
...
In the next figure we have the empirical density (blue) and the fitted density (black). We note that the fitted density explains better the observed data.
